...
fixture`TODO List`.page`http://localhost:3000`
...
test('initial', async t => {
  await t
    ...
    .eql('TODO List0')
    .expect(Selector('input[type="text"]').value)
    .eql('')
})
...
test('add TODO', async t => {
  await t
    ...
    .pressKey('enter')
    .expect(Selector('label').textContent)
    .eql('abc')
    .expect(Selector('input[type="checkbox"]').checked)
    .eql(false)
})
